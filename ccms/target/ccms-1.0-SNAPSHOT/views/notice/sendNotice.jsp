...
<script charset="utf-8" src="/ccms/commons/kindeditor/kindeditor.js"></script>
<script charset="utf-8" src="/ccms/commons/kindeditor/lang/zh_CN.js"></script>
					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" id="addForm"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select data-placeholder="请选择" class="form-control" name="type"
										style="width: 100px" id="type" tabindex="1">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" value="" class="form-control"
										style="width: 300px" name="title" id="title" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<div id="parent_unitInfoDiv"></div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-12">
									<textarea id="mainBody" cols="100" rows="10"
										style="width: 100%; height: 250px; visibility: hidden;"></textarea>
