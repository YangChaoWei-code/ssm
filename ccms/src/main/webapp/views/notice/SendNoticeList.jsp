...
<meta name="keywords" content="已发送消息">
<meta name="description" content="已发送消息">
	...
	$(function() {
		...
		$table.bootstrapTable({
			...
			},
			{
				...
				field : 'id',
				formatter : function(value, row, index) {
					var e = '<a href="#" class="btn btn-gmtx-define1" onclick="check(\''
							+ row.id + '\')">查看</a>';
					var d = '&nbsp;<a href="#" class="btn btn-gmtx-define1" onclick="del(\''
							+ row.id + '\')">删除</a>';
					return e + d;
				}
			} ]
					...
					<div class="ibox-title">
						<div id="tb">
							<button class="btn btn-gmtx-define1"
								onclick="javascript:addNotice()" id="btn_add">新增</button>
						</div>
					</div>
